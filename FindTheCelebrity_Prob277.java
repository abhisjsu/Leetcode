...
/*
*   Solution:
*       if A know B, then A is not the celebrity
*       if A does not know B, then B is not the celebrity
*
*
*/
public class FindTheCelebrity_Prob277 {
    ...
    public int findCelebrity(int n) {
        ...
        for(int i=1;i<n;i++)
        {
            if(knows(candidate,i))
                candidate = i;
        }/* after this loop, the candidate wont know anyone from candidate+1 to n-1*/
...
of whether A knows B. You need to find out the celebrity (or verify there is not one) by asking as few questions
